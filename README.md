# laraBare
Just a new laravel project. A skeleton after a run of composer install. Use this to save that torturing step on poor connections.

I just have this because it took me a　ｗｈｏｌｅ　week to accomplish on a rural/sloppy network. It simply failed and lasted hours and days.
...
God this is PHP not C++. It is an interpreted language not a compiled one. One should be able to get and setup already ready packages even manually, not dealing wit it as if it were a bureaucratic request.
This is merely a rant that simply won't make sense on good quality connections.
